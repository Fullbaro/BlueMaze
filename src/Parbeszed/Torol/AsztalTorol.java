...
public class AsztalTorol extends Keret{
    ...
    public AsztalTorol(String uzenet){
        lCim.setText("Asztal törlése");
        l1.setText(uzenet);
    ...
    void feltolt(){
        flbr.sel=flbr.lekerdez("select nev from asztalok order by nev");
